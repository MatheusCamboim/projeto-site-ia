...
<html lang="pt-BR">
 ...
 <div class="p-3 mb  mb-dark bg-dark text-light">
   <div  class="container" id="titulo">
       <div class="col mt-2 mt-dark">
 ...
 <div class="p-2 mb-1 mb-dark mt-dark bg-dark text-light">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <div class="carousel-caption">
              ...
              <a href="?page=IA" class="btn btn-dark" id="botao1">Ler sobre</a>
            </div>
          </div>
          <div class="carousel-item" >
            ...
            <div class="carousel-caption">
              ...
              <a href="?page=machine" class="btn btn-dark"id="botao2">Ler sobre</a>
            </div>
          </div>
          <div class="carousel-item">
            ...
            <div class="carousel-caption">
              ...
              <a href="?page=deep" class="btn btn-dark" id="botao3">Ler sobre</a>
            </div>
          </div>
        </div>
        <button

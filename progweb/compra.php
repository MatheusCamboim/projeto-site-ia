...
<body>
	...
	<div class="tabela-preco">
		...
		<div class="card-preco">
			<h3 class="card-preco-header">MEIA ARENA</h3>
			<div class="preco"><sup>R$</sup>70<span>/Ingresso</span></div>
			<ul>
			...
			<a href="entrar.php" class="btn">Reservar</a>
			
		</div>
		<div class="card-preco">
			<h3 class="card-preco-header">INTEIRA ARENA</h3>
			<div class="preco"><sup>R$</sup>140<span>/Ingresso</span></div>
			<ul>
				<li>Limite de 3 ingressos</li>
				<li> Reserve para ter prioridade! </li>
				<li><strong>Escolha a quantidade: </strong></li>
